...
public class JavaFXTicTacToeViewController implements ITicTacToeObserver, EventHandler<ActionEvent>
{
	...
	/**
	 * @see fr.polytech.tictactoe.game.ITicTacToeObserver#notifyCellHasBeenMarked(fr.polytech.tictactoe.game.boardgame.Coordinate, fr.polytech.tictactoe.game.players.IPlayer)
	 */
	@Override
	...
	/**
	 * @see fr.polytech.tictactoe.game.ITicTacToeObserver#notifyGameResult(fr.polytech.tictactoe.game.boardgame.GameResult, fr.polytech.tictactoe.game.players.IPlayer)
	 */
	@Override
